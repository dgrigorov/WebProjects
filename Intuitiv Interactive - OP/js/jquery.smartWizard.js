...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        next : $('<a>'+options.labelNext+'</a>').attr("href","#").addClass("buttonNext btn-4 btn-4c icon-arrow-right"),
        previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("buttonPrevious btn btn-4 btn-4d icon-arrow-left"),
    };
    ...
    var _init = function($this) {
        ...
        $this.target.children('ul').addClass("anchor offset5");
