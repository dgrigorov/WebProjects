...
h2#html,
ol.contents li.html a {
    color: #87509c;
}
h2#css,
ol.contents li.css a {
    color: #17c2a4;
}
h2#psd,
ol.contents li.psd a {
    color: #ffbb99;
}
h2#tweaking,
ol.contents li.tweaking a {
    color: #d74680;
}
h2#responsive,
ol.contents li.responsive a {
    color: #3c5499;
}
h2#browser,
ol.contents li.browser a {
    color: #eb7d4b;
}
blockquote {
...
<title>Cuda | Markdown Documentation</title>
</head>
<body>
